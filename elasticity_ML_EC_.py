...
"""
This code utilizes PWSE as discussed in chapter 3.3.5. 
The direct elasticites are computed using the following
equations (equal to equation 17 in chapter 3.3.5).
"""
...
results = res.bioResults(pickle_file='\\\\home.org.aalto.fi\\isoranv1\\data\\myenv\\ML_final.pickle')
...
"""
See Equation 16 in chapter 3.3.5 for the elasticity
